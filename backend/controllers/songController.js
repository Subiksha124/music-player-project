...
const getSongs=async(req,res)=>{
    try{
        const response=await axios.get(`https://api.jamendo.com/v3.0/tracks/?client_id=80e65b0a&format=jsonpretty&limit=15`);
...
const toggleFavourite = async (req, res) => {
 ...
 catch(error)
 {
    ...
    return res.status(400).json({messsage:"Favourities not added,something went wrong"});
 }
}
